...
const contents = readFileSync("usefil.txt", 'utf-8');
const arr = contents.split(/\r?\n/).reverse();
  
const contents2 = readFileSync("flow.txt", "utf-8");
const flowArr = contents2.split(/\r?\n/).reverse();
var j = 0;
var flag = 0;
function ret_flow() {
  var return_value = flowArr[j];
  j++;
  return return_value;
}
...
function ret_random() {
  ...
  var return_value = arr[i];
  i++;
  return return_value;
}


function Aret_random() {
  console.log(arr[i+1]);
  var return_value = arr[i];
  i++;
  return return_value;
...
var init = function() {
    flag = "1212121212121212121212121212121@flare-on.com";
    


    if (flag.length !== 44) {
        console.log("insufficent flag length");
        process.exit(0);
      }
    ...
    //b = [146,125,220,33,150,200,166,95,43,187,74,2,184,194,24,233,78,168,2,6,44,131,58,35,20,48,167,105,80,103,231,187,238,218,192,19,76,46,192,157,32,94,201,98
  ...
  while (true) {
    flag = 1;
    //state ^= Math.floor( ret_random() * (2**30));
    var flow = parseInt(ret_flow());
    flag = 0;
    //console.log(flow + " " + ret_random());
    
    switch (flow) {
      case 306211:
        if ( Aret_random() < 0.5) {
          b[30] += b[34] + b[23] + b[5] + b[37] + b[33] + b[12] + Math.floor( Bret_random() * 256);
          b[30] &= 0xFF;
          console.log("weh");
        } else {
      ...
      case 3396517:
        if (70881172) {
          b[9] ^= (b[12] + b[32] + b[28] + b[43] + b[16] + b[27] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[23] -= b[34] + b[7] + b[32] + b[2] + b[12] + b[11] + Math.floor( ret_random() * 256);
          b[23] &= 0xFF;
        }
        state = 981691089;
        continue;
      ...
      case 8624110:
        if (794146476) {
          ...
          b[24] += b[22] + b[38] + b[33] + b[36] + b[15] + b[43] + Math.floor( ret_random() * 256);
          b[24] &= 0xFF;
        }
        state = 855479214;
        continue;
      ...
      case 13789280:
        if (63441291n) {
          b[9] += b[1] + b[37] + b[40] + b[15] + b[11] + b[10] + Math.floor( ret_random() * 256);
          b[9] &= 0xFF;
        } else {
      ...
      case 16997611:
        if (51321786n) {
          ...
          b[5] ^= (b[35] + b[39] + b[40] + b[16] + b[10] + b[13] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 919058588;
        continue;
      case 17290114:
        if ( Aret_random() < 0.5) {
          ...
          b[40] -= b[24] + b[16] + b[5] + b[33] + b[35] + b[14] + Math.floor( Bret_random() * 256);
          b[40] &= 0xFF;
        }
        state = 372794266;
        continue;
      case 18752034:
        if ( Aret_random() < 0.5) {
          b[9] -= b[4] + b[43] + b[39] + b[16] + b[15] + b[22] + Math.floor( Bret_random() * 256);
          b[9] &= 0xFF;
        } else {
      ...
      case 20347334:
        if (157077096) {
          b[35] -= b[4] + b[25] + b[42] + b[41] + b[17] + b[10] + Math.floor( ret_random() * 256);
          b[35] &= 0xFF;
        } else {
      ...
      case 22221850:
        if (1052707195) {
          b[13] ^= (b[30] + b[33] + b[28] + b[32] + b[12] + b[41] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 27587950:
        if (57380710n) {
          ...
          b[17] += b[34] + b[35] + b[16] + b[9] + b[14] + b[8] + Math.floor( ret_random() * 256);
          b[17] &= 0xFF;
        }
        state = 620289833;
        continue;
      ...
      case 28799325:
        if (62542139n) {
          ...
          b[4] += b[40] + b[9] + b[23] + b[38] + b[18] + b[6] + Math.floor( ret_random() * 256);
          b[4] &= 0xFF;
        }
        state = 984870261;
        continue;
      case 28925148:
        if ( Aret_random() < 0.5) {
          b[34] += b[24] + b[36] + b[5] + b[6] + b[22] + b[11] + Math.floor( Bret_random() * 256);
          b[34] &= 0xFF;
        } else {
          b[26] -= b[16] + b[36] + b[33] + b[2] + b[13] + b[20] + Math.floor( Bret_random() * 256);
          b[26] &= 0xFF;
        }
        state = 909491047;
        continue;
      ...
      case 34833634:
        if (375677031) {
          b[37] -= b[35] + b[19] + b[32] + b[7] + b[41] + b[0] + Math.floor( ret_random() * 256);
          b[37] &= 0xFF;
        } else {
      ...
      case 34972620:
        if (345553606) {
          b[23] -= b[10] + b[40] + b[26] + b[0] + b[28] + b[19] + Math.floor( ret_random() * 256);
          b[23] &= 0xFF;
        } else {
          b[42] -= b[1] + b[29] + b[8] + b[32] + b[23] + b[16] + Math.floor( ret_random() * 256);
          b[42] &= 0xFF;
        }
        state = 299526397;
        continue;
      case 38681753:
        if ( Aret_random() < 0.5) {
          ...
          b[41] -= b[33] + b[12] + b[27] + b[40] + b[9] + b[4] + Math.floor( Bret_random() * 256);
          b[41] &= 0xFF;
        }
        state = 277618656;
        continue;
      case 39901217:
        if (781285820) {
          ...
          b[34] += b[43] + b[0] + b[24] + b[6] + b[36] + b[41] + Math.floor( ret_random() * 256);
          b[34] &= 0xFF;
        }
        state = 465346590;
        continue;
      case 39933208:
        if (927103657) {
          b[18] += b[2] + b[10] + b[6] + b[19] + b[9] + b[15] + Math.floor( ret_random() * 256);
          b[18] &= 0xFF;
        } else {
      ...
      case 42721917:
        if (69259497n) {
          b[28] ^= (b[10] + b[34] + b[31] + b[29] + b[17] + b[11] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 44075365:
        if (419589377) {
          b[24] ^= (b[32] + b[6] + b[39] + b[21] + b[16] + b[15] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 45845929:
        if (893934628) {
          b[30] -= b[13] + b[41] + b[10] + b[19] + b[24] + b[2] + Math.floor( ret_random() * 256);
          b[30] &= 0xFF;
        } else {
      ...
      case 49148585:
        if (417990032) {
          b[1] += b[9] + b[24] + b[17] + b[40] + b[14] + b[26] + Math.floor( ret_random() * 256);
          b[1] &= 0xFF;
        } else {
          b[4] ^= (b[22] + b[2] + b[17] + b[1] + b[9] + b[40] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 487330863;
        continue;
      case 49324191:
      ...
      case 62120866:
        if (82193589n) {
          b[19] -= b[21] + b[17] + b[10] + b[33] + b[28] + b[34] + Math.floor( ret_random() * 256);
          b[19] &= 0xFF;
        } else {
      ...
      case 62123647:
        if (10182515n) {
          b[5] += b[39] + b[26] + b[32] + b[13] + b[40] + b[31] + Math.floor( ret_random() * 256);
          b[5] &= 0xFF;
        } else {
      ...
      case 72161969:
        if ( Aret_random() < 0.5) {
          b[5] -= b[30] + b[23] + b[6] + b[24] + b[15] + b[18] + Math.floor( Bret_random() * 256);
          b[5] &= 0xFF;
        } else {
      ...
      case 72439384:
        if (70328947n) {
          b[24] += b[8] + b[35] + b[21] + b[9] + b[2] + b[22] + Math.floor( ret_random() * 256);
          b[24] &= 0xFF;
        } else {
      ...
      case 72654807:
        if (639707451) {
          ...
          b[21] -= b[24] + b[22] + b[26] + b[0] + b[36] + b[6] + Math.floor( ret_random() * 256);
          b[21] &= 0xFF;
        }
        state = 200999436;
        continue;
      case 73566854:
        if (29773184n) {
          ...
          b[25] += b[17] + b[0] + b[37] + b[39] + b[11] + b[28] + Math.floor( ret_random() * 256);
          b[25] &= 0xFF;
        }
        state = 647560898;
        continue;
      ...
      case 79593073:
        if ( Aret_random() < 0.5) {
          ...
          b[37] -= b[29] + b[35] + b[20] + b[22] + b[43] + b[32] + Math.floor( Bret_random() * 256);
          b[37] &= 0xFF;
        }
        state = 384670766;
        continue;
      ...
      case 82799741:
        if ( Aret_random() < 0.5) {
          ...
          b[29] -= b[23] + b[31] + b[18] + b[15] + b[11] + b[37] + Math.floor( Bret_random() * 256);
          b[29] &= 0xFF;
        }
        state = 385701510;
        continue;
      case 84809963:
        if ( Aret_random() < 0.5) {
          b[26] -= b[8] + b[12] + b[33] + b[39] + b[19] + b[29] + Math.floor( Bret_random() * 256);
          b[26] &= 0xFF;
        } else {
          b[32] ^= (b[23] + b[14] + b[39] + b[41] + b[42] + b[18] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 504774667;
        continue;
      case 85080588:
        if (762957074) {
          ...
          b[29] -= b[13] + b[1] + b[28] + b[14] + b[41] + b[26] + Math.floor( ret_random() * 256);
          b[29] &= 0xFF;
        }
        state = 670620031;
        continue;
      case 86006683:
        if (26903160n) {
          b[22] -= b[29] + b[42] + b[40] + b[38] + b[8] + b[6] + Math.floor( ret_random() * 256);
          b[22] &= 0xFF;
        } else {
      ...
      case 89525183:
        if ( Aret_random() < 0.5) {
          b[16] -= b[8] + b[41] + b[28] + b[0] + b[21] + b[34] + Math.floor( Bret_random() * 256);
          b[16] &= 0xFF;
        } else {
          b[25] -= b[16] + b[21] + b[28] + b[35] + b[14] + b[37] + Math.floor( Bret_random() * 256);
          b[25] &= 0xFF;
        }
        state = 845956452;
        continue;
      ...
      case 95732224:
        if (54814413n) {
          ...
          b[19] ^= (b[13] + b[36] + b[38] + b[1] + b[2] + b[24] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 42840541;
        continue;
      case 96456627:
      ...
      case 100941470:
        if (61552821n) {
          b[10] -= b[35] + b[24] + b[36] + b[12] + b[18] + b[7] + Math.floor( ret_random() * 256);
          b[10] &= 0xFF;
        } else {
      ...
      case 104812740:
        if (282147743) {
          ...
          b[41] -= b[33] + b[9] + b[34] + b[26] + b[3] + b[14] + Math.floor( ret_random() * 256);
          b[41] &= 0xFF;
        }
        state = 625809930;
        continue;
      ...
      case 105837962:
        if (25999949n) {
          ...
          b[40] ^= (b[13] + b[15] + b[22] + b[24] + b[43] + b[39] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 548604337;
        continue;
      case 107012627:
        if (843375165) {
          b[19] += b[26] + b[43] + b[15] + b[22] + b[35] + b[25] + Math.floor( ret_random() * 256);
          b[19] &= 0xFF;
        } else {
      ...
      case 107361852:
        if (71427674n) {
          ...
          b[2] ^= (b[32] + b[41] + b[24] + b[22] + b[17] + b[21] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 533630845;
        continue;
      case 107684849:
        if ( Aret_random() < 0.5) {
          b[31] ^= (b[16] + b[13] + b[28] + b[21] + b[0] + b[27] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
          b[42] ^= (b[43] + b[41] + b[15] + b[4] + b[21] + b[29] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 353740394;
        continue;
      case 107948494:
      ...
      case 114492214:
        if (133555304) {
          ...
          b[7] ^= (b[16] + b[24] + b[28] + b[32] + b[4] + b[5] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 593990082;
        continue;
      case 117244801:
        if (2243214) {
          b[32] -= b[2] + b[14] + b[19] + b[43] + b[4] + b[30] + Math.floor( ret_random() * 256);
          b[32] &= 0xFF;
        } else {
      ...
      case 124291036:
        if (71613682n) {
          b[2] -= b[43] + b[27] + b[6] + b[32] + b[34] + b[14] + Math.floor( ret_random() * 256);
          b[2] &= 0xFF;
        } else {
      ...
      case 124331859:
        if (909168317) {
          ...
          b[42] ^= (b[13] + b[2] + b[20] + b[16] + b[6] + b[34] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 341128420;
        continue;
      case 124690486:
      ...
      case 129226256:
        if (691330426) {
          ...
          b[8] += b[40] + b[12] + b[41] + b[20] + b[5] + b[30] + Math.floor( ret_random() * 256);
          b[8] &= 0xFF;
        }
        state = 210970895;
        continue;
      ...
      case 132987555:
        if (228460182) {
          b[35] -= b[1] + b[37] + b[3] + b[10] + b[28] + b[4] + Math.floor( ret_random() * 256);
          b[35] &= 0xFF;
        } else {
      ...
      case 134845953:
        if (51096671n) {
          b[42] -= b[29] + b[14] + b[31] + b[22] + b[36] + b[33] + Math.floor( ret_random() * 256);
          b[42] &= 0xFF;
        } else {
      ...
      case 136698433:
        if (384726620) {
          b[24] -= b[14] + b[38] + b[4] + b[12] + b[5] + b[0] + Math.floor( ret_random() * 256);
          b[24] &= 0xFF;
        } else {
      ...
      case 137590596:
        if (802464505) {
          ...
          b[41] ^= (b[28] + b[0] + b[23] + b[12] + b[37] + b[29] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 875069506;
        continue;
      case 137630475:
      ...
      case 138090095:
        if ( Aret_random() < 0.5) {
          ...
          b[3] ^= (b[1] + b[38] + b[15] + b[35] + b[25] + b[23] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 587130542;
        continue;
      case 141811531:
      ...
      case 149778348:
        if (372901593) {
          b[14] ^= (b[42] + b[15] + b[25] + b[38] + b[1] + b[0] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 152320376:
        if ( Aret_random() < 0.5) {
          b[4] += b[5] + b[36] + b[6] + b[8] + b[7] + b[35] + Math.floor( Bret_random() * 256);
          b[4] &= 0xFF;
        } else {
      ...
      case 158440818:
        if ( Aret_random() < 0.5) {
          ...
          b[11] ^= (b[9] + b[29] + b[14] + b[12] + b[5] + b[15] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 68807763;
        continue;
      case 160122652:
      ...
      case 160364872:
        if (407632658) {
          b[16] ^= (b[9] + b[41] + b[1] + b[4] + b[42] + b[29] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 162618506:
        if (36454975n) {
          ...
          b[25] -= b[34] + b[28] + b[19] + b[36] + b[0] + b[3] + Math.floor( ret_random() * 256);
          b[25] &= 0xFF;
        }
        state = 10280958;
        continue;
      ...
      case 163327990:
        if (80981608n) {
          b[40] -= b[37] + b[29] + b[8] + b[19] + b[0] + b[27] + Math.floor( ret_random() * 256);
          b[40] &= 0xFF;
        } else {
          b[3] += b[9] + b[26] + b[6] + b[29] + b[5] + b[20] + Math.floor( ret_random() * 256);
          b[3] &= 0xFF;
        }
        state = 778318794;
        continue;
      ...
      case 167118666:
        if ( Aret_random() < 0.5) {
          b[21] -= b[23] + b[34] + b[14] + b[30] + b[39] + b[35] + Math.floor( Bret_random() * 256);
          b[21] &= 0xFF;
        } else {
      ...
      case 167389661:
        if ( Aret_random() < 0.5) {
          b[6] += b[2] + b[13] + b[39] + b[16] + b[11] + b[38] + Math.floor( Bret_random() * 256);
          b[6] &= 0xFF;
        } else {
      ...
      case 170255883:
        if (11255342n) {
          b[0] ^= (b[32] + b[31] + b[26] + b[4] + b[27] + b[10] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[0] ^= (b[17] + b[32] + b[8] + b[37] + b[14] + b[1] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 183251124;
        continue;
      case 170938055:
      ...
      case 170953037:
        if ( Aret_random() < 0.5) {
          b[25] -= b[7] + b[21] + b[12] + b[24] + b[35] + b[42] + Math.floor( Bret_random() * 256);
          b[25] &= 0xFF;
        } else {
      ...
      case 171959181:
        if (941297648) {
          b[15] ^= (b[0] + b[28] + b[38] + b[18] + b[6] + b[24] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 174428270:
        if (897865398) {
          ...
          b[32] -= b[22] + b[25] + b[2] + b[43] + b[37] + b[28] + Math.floor( ret_random() * 256);
          b[32] &= 0xFF;
        }
        state = 480041842;
        continue;
      case 176965404:
        if ( Aret_random() < 0.5) {
          ...
          b[1] += b[32] + b[31] + b[34] + b[16] + b[28] + b[35] + Math.floor( Bret_random() * 256);
          b[1] &= 0xFF;
        }
        state = 942374808;
        continue;
      case 177511412:
        if (206667095) {
          b[12] -= b[38] + b[35] + b[5] + b[0] + b[33] + b[6] + Math.floor( ret_random() * 256);
          b[12] &= 0xFF;
        } else {
      ...
      case 177706338:
        if (63824188n) {
          b[2] ^= (b[23] + b[1] + b[14] + b[22] + b[38] + b[26] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 180361118:
        if ( Aret_random() < 0.5) {
          b[12] -= b[17] + b[8] + b[37] + b[39] + b[22] + b[35] + Math.floor( Bret_random() * 256);
          b[12] &= 0xFF;
        } else {
      ...
      case 181384715:
        if ( Aret_random() < 0.5) {
          ...
          b[5] ^= (b[27] + b[33] + b[10] + b[3] + b[42] + b[40] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 110990963;
        continue;
      case 182615591:
      ...
      case 184565984:
        if ( Aret_random() < 0.5) {
          ...
          b[6] += b[16] + b[25] + b[36] + b[40] + b[31] + b[5] + Math.floor( Bret_random() * 256);
          b[6] &= 0xFF;
        }
        state = 666284843;
        continue;
      case 184938092:
        if (58279263n) {
          ...
          b[22] -= b[10] + b[37] + b[34] + b[12] + b[16] + b[2] + Math.floor( ret_random() * 256);
          b[22] &= 0xFF;
        }
        state = 788352180;
        continue;
      case 185078700:
        console.log("continue actually");
        continue;
      case 188837611:
        if (509459627) {
          b[2] ^= (b[26] + b[29] + b[30] + b[33] + b[27] + b[1] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 194234029:
        if ( Aret_random() < 0.5) {
          b[22] -= b[11] + b[42] + b[30] + b[20] + b[28] + b[4] + Math.floor( Bret_random() * 256);
          b[22] &= 0xFF;
        } else {
      ...
      case 194691887:
        if (75933549) {
          ...
          b[33] += b[28] + b[34] + b[27] + b[36] + b[3] + b[39] + Math.floor( ret_random() * 256);
          b[33] &= 0xFF;
        }
        state = 397807652;
        continue;
      ...
      case 206186554:
        if (78711938n) {
          ...
          b[37] -= b[20] + b[11] + b[16] + b[31] + b[22] + b[0] + Math.floor( ret_random() * 256);
          b[37] &= 0xFF;
        }
        state = 825535610;
        continue;
      ...
      case 209432887:
        if (93470664n) {
          b[34] -= b[42] + b[35] + b[11] + b[29] + b[22] + b[20] + Math.floor( ret_random() * 256);
          b[34] &= 0xFF;
        } else {
          b[10] ^= (b[29] + b[32] + b[8] + b[4] + b[30] + b[23] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 1038100041;
        continue;
      case 209848935:
      ...
      case 217091233:
        if (933239764) {
          b[0] -= b[31] + b[33] + b[25] + b[29] + b[43] + b[26] + Math.floor( ret_random() * 256);
          b[0] &= 0xFF;
        } else {
      ...
      case 220609761:
        if (58258984n) {
          b[31] += b[22] + b[30] + b[4] + b[35] + b[20] + b[26] + Math.floor( ret_random() * 256);
          b[31] &= 0xFF;
        } else {
      ...
      case 220618710:
        if (92040774n) {
          ...
          b[10] += b[20] + b[39] + b[25] + b[17] + b[26] + b[22] + Math.floor( ret_random() * 256);
          b[10] &= 0xFF;
        }
        state = 620893593;
        continue;
      ...
      case 221781532:
        if (72652111n) {
          b[26] ^= (b[35] + b[31] + b[12] + b[1] + b[15] + b[27] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 225422723:
        if ( Aret_random() < 0.5) {
          ...
          b[28] -= b[7] + b[16] + b[42] + b[25] + b[24] + b[13] + Math.floor( Bret_random() * 256);
          b[28] &= 0xFF;
        }
        state = 189630997;
        continue;
      ...
      case 230930038:
        if (386539893) {
          ...
          b[40] += b[8] + b[26] + b[31] + b[38] + b[32] + b[37] + Math.floor( ret_random() * 256);
          b[40] &= 0xFF;
        }
        state = 746309371;
        continue;
      case 231432592:
        if ( Aret_random() < 0.5) {
          b[4] -= b[43] + b[32] + b[12] + b[24] + b[3] + b[9] + Math.floor( Bret_random() * 256);
          b[4] &= 0xFF;
        } else {
      ...
      case 234522330:
        if (59337487n) {
          ...
          b[29] += b[38] + b[14] + b[34] + b[18] + b[43] + b[35] + Math.floor( ret_random() * 256);
          b[29] &= 0xFF;
        }
        state = 1068988450;
        continue;
      ...
      case 238161391:
        if (17051732n) {
          b[11] += b[43] + b[24] + b[34] + b[5] + b[32] + b[17] + Math.floor( ret_random() * 256);
          b[11] &= 0xFF;
        } else {
          b[28] -= b[26] + b[18] + b[1] + b[5] + b[32] + b[19] + Math.floor( ret_random() * 256);
          b[28] &= 0xFF;
        }
        state = 586451322;
        continue;
      ...
      case 246084964:
        if (693526256) {
          b[34] ^= (b[6] + b[0] + b[12] + b[25] + b[41] + b[43] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 246196592:
        if ( Aret_random() < 0.5) {
          ...
          b[24] += b[36] + b[39] + b[27] + b[8] + b[14] + b[34] + Math.floor( Bret_random() * 256);
          b[24] &= 0xFF;
        }
        state = 467042858;
        continue;
      case 246665663:
        if (179082165) {
          ...
          b[27] -= b[13] + b[37] + b[23] + b[17] + b[2] + b[43] + Math.floor( ret_random() * 256);
          b[27] &= 0xFF;
        }
        state = 618341793;
        continue;
      ...
      case 260248466:
        if (14496527n) {
          ...
          b[43] += b[4] + b[20] + b[36] + b[25] + b[22] + b[7] + Math.floor( ret_random() * 256);
          b[43] &= 0xFF;
        }
        state = 649829285;
        continue;
      case 261461743:
        if ( Aret_random() < 0.5) {
          b[31] += b[14] + b[43] + b[19] + b[36] + b[41] + b[8] + Math.floor( Bret_random() * 256);
          b[31] &= 0xFF;
        } else {
      ...
      case 261889048:
        if (419825796) {
          b[1] += b[35] + b[43] + b[16] + b[15] + b[13] + b[2] + Math.floor( ret_random() * 256);
          b[1] &= 0xFF;
        } else {
      ...
      case 266322968:
        if (65586349n) {
          ...
          b[42] += b[32] + b[27] + b[40] + b[28] + b[33] + b[9] + Math.floor( ret_random() * 256);
          b[42] &= 0xFF;
        }
        state = 796003565;
        continue;
      case 267460296:
        if ( Aret_random() < 0.5) {
          b[19] += b[34] + b[15] + b[42] + b[20] + b[37] + b[33] + Math.floor( Bret_random() * 256);
          b[19] &= 0xFF;
        } else {
          b[5] += b[29] + b[22] + b[2] + b[30] + b[19] + b[7] + Math.floor( ret_random() * 256);
          b[5] &= 0xFF;
        }
        state = 455908408;
        continue;
      ...
      case 275097633:
        if ( Aret_random() < 0.5) {
          b[12] ^= (b[27] + b[41] + b[29] + b[26] + b[36] + b[31] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 275423299:
        if (16039728n) {
          b[7] ^= (b[19] + b[3] + b[16] + b[1] + b[34] + b[33] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 275553514:
        if (232479927) {
          b[42] += b[21] + b[25] + b[29] + b[24] + b[6] + b[33] + Math.floor( ret_random() * 256);
          b[42] &= 0xFF;
        } else {
      ...
      case 280767414:
        if ( Aret_random() < 0.5) {
          b[11] -= b[14] + b[0] + b[4] + b[20] + b[7] + b[27] + Math.floor( Bret_random() * 256);
          b[11] &= 0xFF;
        } else {
      ...
      case 283679858:
        if (477182091) {
          b[31] -= b[21] + b[41] + b[26] + b[27] + b[6] + b[43] + Math.floor( ret_random() * 256);
          b[31] &= 0xFF;
        } else {
      ...
      case 285069999:
        if ( Aret_random() < 0.5) {
          b[14] -= b[0] + b[28] + b[10] + b[6] + b[2] + b[8] + Math.floor( Bret_random() * 256);
          b[14] &= 0xFF;
        } else {
      ...
      case 287357895:
        if ( Aret_random() < 0.5) {
          b[5] ^= (b[17] + b[26] + b[15] + b[24] + b[40] + b[29] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
          b[1] += b[27] + b[6] + b[10] + b[23] + b[35] + b[22] + Math.floor( Bret_random() * 256);
          b[1] &= 0xFF;
        }
        state = 145686511;
        continue;
      ...
      case 288255168:
        if (972634646) {
          b[36] ^= (b[23] + b[35] + b[41] + b[15] + b[24] + b[17] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 288574193:
        if ( Aret_random() < 0.5) {
          b[34] -= b[32] + b[2] + b[1] + b[42] + b[40] + b[31] + Math.floor( Bret_random() * 256);
          b[34] &= 0xFF;
        } else {
      ...
      case 292965864:
        if (88816545n) {
          ...
          b[27] ^= (b[25] + b[29] + b[34] + b[13] + b[41] + b[5] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 926464768;
        continue;
      case 293954309:
      ...
      case 294918952:
        if (33776471n) {
          b[10] -= b[20] + b[16] + b[0] + b[17] + b[14] + b[5] + Math.floor( ret_random() * 256);
          b[10] &= 0xFF;
        } else {
          b[42] -= b[7] + b[13] + b[3] + b[6] + b[28] + b[5] + Math.floor( ret_random() * 256);
          b[42] &= 0xFF;
        }
        state = 677579458;
        continue;
      case 296261627:
        if ( Aret_random() < 0.5) {
          ...
          b[3] ^= (b[34] + b[14] + b[33] + b[28] + b[15] + b[36] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 786912410;
        continue;
      case 297638766:
      ...
      case 308969481:
        if (61075735n) {
          b[31] += b[33] + b[6] + b[1] + b[29] + b[23] + b[4] + Math.floor( ret_random() * 256);
          b[31] &= 0xFF;
        } else {
      ...
      case 310398609:
        if ( Aret_random() < 0.5) {
          ...
          b[41] += b[18] + b[30] + b[14] + b[38] + b[5] + b[26] + Math.floor( Bret_random() * 256);
          b[41] &= 0xFF;
        }
        state = 627325155;
        continue;
      ...
      case 314005330:
        if (72635016n) {
          ...
          b[17] ^= (b[18] + b[42] + b[33] + b[21] + b[29] + b[7] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 771896895;
        continue;
      case 316553773:
        if (64078358n) {
          ...
          b[18] -= b[42] + b[17] + b[26] + b[39] + b[4] + b[43] + Math.floor( ret_random() * 256);
          b[18] &= 0xFF;
        }
        state = 962667923;
        continue;
      case 316759147:
        if ( Aret_random() < 0.5) {
          b[21] -= b[42] + b[12] + b[8] + b[25] + b[27] + b[6] + Math.floor( Bret_random() * 256);
          b[21] &= 0xFF;
        } else {
      ...
      case 322224592:
        if (51026408n) {
          b[19] ^= (b[16] + b[10] + b[3] + b[5] + b[39] + b[0] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 324375396:
        if ( Aret_random() < 0.5) {
          b[16] += b[39] + b[1] + b[19] + b[10] + b[14] + b[26] + Math.floor( Bret_random() * 256);
          b[16] &= 0xFF;
        } else {
      ...
      case 326512739:
        if (57599802n) {
          ...
          b[15] ^= (b[2] + b[39] + b[21] + b[11] + b[10] + b[5] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 881516063;
        continue;
      case 326894214:
        if ( Aret_random() < 0.5) {
          ...
          b[0] -= b[21] + b[26] + b[20] + b[27] + b[33] + b[29] + Math.floor( Bret_random() * 256);
          b[0] &= 0xFF;
        }
        state = 469020671;
        continue;
      case 327658034:
        if (87861049) {
          b[35] ^= (b[8] + b[16] + b[9] + b[23] + b[29] + b[12] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 328293975:
        if (487164505) {
          ...
          b[7] += b[38] + b[42] + b[28] + b[6] + b[16] + b[25] + Math.floor( ret_random() * 256);
          b[7] &= 0xFF;
        }
        state = 242015430;
        continue;
      ...
      case 333327748:
        if ( Aret_random() < 0.5) {
          ...
          b[16] ^= (b[11] + b[33] + b[22] + b[7] + b[0] + b[29] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 503956735;
        continue;
      case 333413964:
        if ( Aret_random() < 0.5) {
          ...
          b[2] -= b[26] + b[41] + b[35] + b[1] + b[18] + b[34] + Math.floor( Bret_random() * 256);
          b[2] &= 0xFF;
        }
        state = 743277227;
        continue;
      ...
      case 337619620:
        if (844294543) {
          ...
          b[34] += b[21] + b[5] + b[41] + b[10] + b[24] + b[38] + Math.floor( ret_random() * 256);
          b[34] &= 0xFF;
        }
        state = 648181894;
        continue;
      ...
      case 343068132:
        if ( Aret_random() < 0.5) {
          b[43] -= b[13] + b[27] + b[15] + b[12] + b[6] + b[5] + Math.floor( Bret_random() * 256);
          b[43] &= 0xFF;
        } else {
      ...
      case 355878506:
        if (36769050n) {
          ...
          b[2] ^= (b[12] + b[11] + b[39] + b[31] + b[43] + b[36] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 899648181;
        continue;
      case 356968013:
      ...
      case 357341428:
        if (29320591n) {
          ...
          b[14] ^= (b[0] + b[21] + b[12] + b[31] + b[11] + b[5] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 206476859;
        continue;
      case 358432243:
      ...
      case 365857434:
        if ( Aret_random() < 0.5) {
          ...
          b[7] ^= (b[41] + b[42] + b[5] + b[39] + b[33] + b[18] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 306782152;
        continue;
      case 366327144:
      ...
      case 377623173:
        if ( Aret_random() < 0.5) {
          b[25] ^= (b[10] + b[19] + b[34] + b[40] + b[12] + b[6] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 381813752:
        if ( Aret_random() < 0.5) {
          b[25] ^= (b[6] + b[43] + b[29] + b[27] + b[13] + b[14] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 382922372:
        if ( Aret_random() < 0.5) {
          b[27] ^= (b[39] + b[14] + b[33] + b[22] + b[6] + b[28] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 383403877:
        if ( Aret_random() < 0.5) {
          b[42] ^= (b[20] + b[38] + b[37] + b[12] + b[35] + b[41] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 388611681:
        if (942571809) {
          ...
          b[43] -= b[40] + b[23] + b[21] + b[26] + b[6] + b[33] + Math.floor( ret_random() * 256);
          b[43] &= 0xFF;
        }
        state = 116844593;
        continue;
      ...
      case 391748300:
        if (892824005) {
          b[16] -= b[21] + b[33] + b[35] + b[22] + b[31] + b[13] + Math.floor( ret_random() * 256);
          b[16] &= 0xFF;
        } else {
          b[16] += b[32] + b[4] + b[31] + b[8] + b[29] + b[14] + Math.floor( ret_random() * 256);
          b[16] &= 0xFF;
        }
        state = 865534450;
        continue;
      ...
      case 393219787:
        if (919953243) {
          ...
          b[30] += b[6] + b[14] + b[28] + b[29] + b[24] + b[15] + Math.floor( ret_random() * 256);
          b[30] &= 0xFF;
        }
        state = 231414023;
        continue;
      ...
      case 394802322:
        if (67677057n) {
          b[36] ^= (b[40] + b[22] + b[17] + b[27] + b[0] + b[39] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[2] += b[15] + b[41] + b[7] + b[29] + b[23] + b[24] + Math.floor( ret_random() * 256);
          b[2] &= 0xFF;
        }
        state = 336616975;
        continue;
      ...
      case 397157371:
        if (33892584n) {
          b[43] -= b[28] + b[14] + b[12] + b[40] + b[16] + b[39] + Math.floor( ret_random() * 256);
          b[43] &= 0xFF;
        } else {
      ...
      case 406937840:
        if ( Aret_random() < 0.5) {
          ...
          b[13] ^= (b[37] + b[3] + b[36] + b[17] + b[12] + b[2] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 48873310;
        continue;
      case 407028537:
      ...
      case 410802044:
        if (11042713n) {
          ...
          b[42] ^= (b[20] + b[31] + b[38] + b[36] + b[0] + b[19] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 936452181;
        continue;
      case 410923009:
      ...
      case 412251143:
        if (62372014n) {
          ...
          b[36] -= b[33] + b[13] + b[26] + b[27] + b[5] + b[24] + Math.floor( ret_random() * 256);
          b[36] &= 0xFF;
        }
        state = 490551708;
        continue;
      case 412918289:
        if (808576349) {
          b[38] -= b[22] + b[8] + b[3] + b[10] + b[7] + b[35] + Math.floor( ret_random() * 256);
          b[38] &= 0xFF;
        } else {
      ...
      case 413708432:
        if ( Aret_random() < 0.5) {
          b[18] -= b[4] + b[9] + b[3] + b[12] + b[26] + b[1] + Math.floor( Bret_random() * 256);
          b[18] &= 0xFF;
        } else {
      ...
      case 414443906:
        if ( Aret_random() < 0.5) {
          b[33] += b[5] + b[41] + b[16] + b[32] + b[35] + b[36] + Math.floor( Bret_random() * 256);
          b[33] &= 0xFF;
        } else {
      ...
      case 414456846:
        if (13208116n) {
          b[6] += b[30] + b[29] + b[14] + b[35] + b[15] + b[20] + Math.floor( ret_random() * 256);
          b[6] &= 0xFF;
        } else {
      ...
      case 418085472:
        if (449660790) {
          b[42] += b[35] + b[40] + b[1] + b[29] + b[30] + b[15] + Math.floor( ret_random() * 256);
          b[42] &= 0xFF;
        } else {
          b[13] += b[33] + b[28] + b[19] + b[27] + b[6] + b[12] + Math.floor( ret_random() * 256);
          b[13] &= 0xFF;
        }
        state = 445117433;
        continue;
      ...
      case 421002955:
        if ( Aret_random() < 0.5) {
          ...
          b[20] -= b[3] + b[12] + b[40] + b[43] + b[15] + b[28] + Math.floor( Bret_random() * 256);
          b[20] &= 0xFF;
        }
        state = 346979242;
        continue;
      case 421677992:
        if (610991075) {
          ...
          b[43] -= b[35] + b[40] + b[41] + b[36] + b[10] + b[39] + Math.floor( ret_random() * 256);
          b[43] &= 0xFF;
        }
        state = 11258425;
        continue;
      case 422010113:
        if (14463569n) {
          ...
          b[35] -= b[13] + b[21] + b[32] + b[1] + b[10] + b[43] + Math.floor( ret_random() * 256);
          b[35] &= 0xFF;
        }
        state = 207711035;
        continue;
      ...
      case 431298389:
        if (20560274n) {
          ...
          b[42] += b[5] + b[27] + b[38] + b[26] + b[41] + b[21] + Math.floor( ret_random() * 256);
          b[42] &= 0xFF;
        }
        state = 434234745;
        continue;
      ...
      case 433190983:
        if ( Aret_random() < 0.5) {
          b[43] += b[28] + b[41] + b[5] + b[32] + b[36] + b[1] + Math.floor( Bret_random() * 256);
          b[43] &= 0xFF;
        } else {
      ...
      case 435026594:
        if (37718035n) {
          ...
          b[19] -= b[27] + b[15] + b[21] + b[26] + b[31] + b[33] + Math.floor( ret_random() * 256);
          b[19] &= 0xFF;
        }
        state = 479609427;
        continue;
      case 435082171:
        if (432348810) {
          ...
          b[10] -= b[5] + b[31] + b[18] + b[9] + b[24] + b[27] + Math.floor( ret_random() * 256);
          b[10] &= 0xFF;
        }
        state = 716798066;
        continue;
      ...
      case 436361812:
        if (38134580n) {
          b[2] += b[36] + b[1] + b[26] + b[30] + b[6] + b[13] + Math.floor( ret_random() * 256);
          b[2] &= 0xFF;
        } else {
      ...
      case 440786193:
        if (67667498n) {
          b[39] += b[4] + b[31] + b[22] + b[5] + b[17] + b[1] + Math.floor( ret_random() * 256);
          b[39] &= 0xFF;
        } else {
      ...
      case 444826173:
        if (446404210) {
          b[43] ^= (b[17] + b[37] + b[31] + b[14] + b[5] + b[16] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 445253239:
        if (327650681) {
          b[28] -= b[23] + b[10] + b[6] + b[1] + b[9] + b[39] + Math.floor( ret_random() * 256);
          b[28] &= 0xFF;
        } else {
          b[0] -= b[25] + b[13] + b[38] + b[31] + b[14] + b[30] + Math.floor( ret_random() * 256);
          b[0] &= 0xFF;
        }
        state = 1024125547;
        continue;
      ...
      case 454239079:
        if (89679766) {
          b[4] ^= (b[6] + b[1] + b[24] + b[14] + b[3] + b[31] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 455195714:
        if ( Aret_random() < 0.5) {
          b[29] ^= (b[27] + b[23] + b[8] + b[14] + b[16] + b[10] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 458923952:
        if ( Aret_random() < 0.5) {
          b[21] ^= (b[36] + b[31] + b[1] + b[20] + b[43] + b[17] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
          b[41] += b[2] + b[43] + b[23] + b[8] + b[40] + b[7] + Math.floor( Bret_random() * 256);
          b[41] &= 0xFF;
        }
        state = 702149658;
        continue;
      case 460713018:
        if ( Aret_random() < 0.5) {
          ...
          b[12] ^= (b[32] + b[14] + b[5] + b[30] + b[42] + b[33] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 229819407;
        continue;
      case 461379671:
        if (47840585n) {
          b[41] += b[28] + b[21] + b[25] + b[31] + b[2] + b[36] + Math.floor( ret_random() * 256);
          b[41] &= 0xFF;
        } else {
      ...
      case 462197583:
        if (89691202n) {
          ...
          b[32] += b[11] + b[19] + b[2] + b[5] + b[6] + b[35] + Math.floor( ret_random() * 256);
          b[32] &= 0xFF;
        }
        state = 218242848;
        continue;
      ...
      case 463157616:
        if ( Aret_random() < 0.5) {
          ...
          b[40] -= b[30] + b[29] + b[16] + b[39] + b[9] + b[6] + Math.floor( Bret_random() * 256);
          b[40] &= 0xFF;
        }
        state = 168379940;
        continue;
      ...
      case 469950833:
        if ( Aret_random() < 0.5) {
          ...
          b[25] += b[34] + b[32] + b[43] + b[22] + b[39] + b[17] + Math.floor( Bret_random() * 256);
          b[25] &= 0xFF;
        }
        state = 65139032;
        continue;
      case 470915230:
        if (655599971) {
          ...
          b[38] += b[14] + b[3] + b[35] + b[40] + b[6] + b[5] + Math.floor( ret_random() * 256);
          b[38] &= 0xFF;
        }
        state = 115237491;
        continue;
      case 472968028:
        if (24605414n) {
          ...
          b[11] ^= (b[21] + b[28] + b[23] + b[7] + b[31] + b[26] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 256880408;
        continue;
      case 472997066:
        if (886419875) {
          ...
          b[20] += b[19] + b[7] + b[11] + b[33] + b[18] + b[1] + Math.floor( ret_random() * 256);
          b[20] &= 0xFF;
        }
        state = 300099556;
        continue;
      case 475240679:
        if ( Aret_random() < 0.5) {
          b[40] += b[42] + b[17] + b[38] + b[14] + b[41] + b[30] + Math.floor( Bret_random() * 256);
          b[40] &= 0xFF;
        } else {
      ...
      case 477914619:
        if ( Aret_random() < 0.5) {
          b[37] ^= (b[28] + b[5] + b[29] + b[0] + b[10] + b[41] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 478340892:
        if ( Aret_random() < 0.5) {
          b[5] -= b[39] + b[18] + b[43] + b[8] + b[15] + b[14] + Math.floor( Bret_random() * 256);
          b[5] &= 0xFF;
        } else {
      ...
      case 479868974:
        if (42718766n) {
          b[41] += b[32] + b[42] + b[15] + b[9] + b[17] + b[0] + Math.floor( ret_random() * 256);
          b[41] &= 0xFF;
        } else {
          b[19] ^= (b[3] + b[30] + b[17] + b[15] + b[13] + b[18] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 65570416;
        continue;
      case 479895768:
        if (89471903n) {
          b[26] ^= (b[24] + b[7] + b[11] + b[12] + b[38] + b[3] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 484432842:
        if (898392674) {
          ...
          b[28] -= b[16] + b[25] + b[40] + b[23] + b[0] + b[24] + Math.floor( ret_random() * 256);
          b[28] &= 0xFF;
        }
        state = 787080846;
        continue;
      ...
      case 488117931:
        if (72782462) {
          b[29] -= b[42] + b[36] + b[3] + b[16] + b[30] + b[5] + Math.floor( ret_random() * 256);
          b[29] &= 0xFF;
        } else {
          b[34] -= b[12] + b[20] + b[15] + b[38] + b[23] + b[11] + Math.floor( ret_random() * 256);
          b[34] &= 0xFF;
        }
        state = 653944692;
        continue;
      ...
      case 492685924:
        if ( Aret_random() < 0.5) {
          b[37] ^= (b[23] + b[8] + b[1] + b[14] + b[43] + b[17] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 497039019:
        if (43116320n) {
          b[32] += b[8] + b[19] + b[43] + b[0] + b[2] + b[1] + Math.floor( ret_random() * 256);
          b[32] &= 0xFF;
        } else {
      ...
      case 497278214:
        if (959009418) {
          b[12] -= b[14] + b[13] + b[17] + b[22] + b[25] + b[38] + Math.floor( ret_random() * 256);
          b[12] &= 0xFF;
        } else {
      ...
      case 504039263:
        if (66702658n) {
          b[0] -= b[17] + b[10] + b[16] + b[38] + b[22] + b[15] + Math.floor( ret_random() * 256);
          b[0] &= 0xFF;
        } else {
      ...
      case 508258165:
        if ( Aret_random() < 0.5) {
          ...
          b[31] += b[40] + b[9] + b[21] + b[34] + b[7] + b[12] + Math.floor( Bret_random() * 256);
          b[31] &= 0xFF;
        }
        state = 78331563;
        continue;
      ...
      case 509314672:
        if ( Aret_random() < 0.5) {
          ...
          b[19] -= b[28] + b[30] + b[4] + b[10] + b[15] + b[17] + Math.floor( Bret_random() * 256);
          b[19] &= 0xFF;
        }
        state = 291891829;
        continue;
      ...
      case 512178077:
        if (732450855) {
          ...
          b[32] ^= (b[16] + b[4] + b[23] + b[8] + b[41] + b[29] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 740993309;
        continue;
      case 513668468:
      ...
      case 514347277:
        if (42732613n) {
          b[12] ^= (b[37] + b[8] + b[16] + b[20] + b[17] + b[1] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[33] ^= (b[10] + b[22] + b[2] + b[1] + b[30] + b[11] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 385158166;
        continue;
      case 515148309:
      ...
      case 516077630:
        if (882468081) {
          b[0] += b[35] + b[19] + b[7] + b[40] + b[22] + b[33] + Math.floor( ret_random() * 256);
          b[0] &= 0xFF;
        } else {
      ...
      case 522895656:
        if (299124257) {
          b[26] += b[24] + b[6] + b[3] + b[23] + b[31] + b[41] + Math.floor( ret_random() * 256);
          b[26] &= 0xFF;
        } else {
      ...
      case 525513317:
        if (1045931426) {
          b[33] -= b[35] + b[8] + b[12] + b[18] + b[14] + b[17] + Math.floor( ret_random() * 256);
          b[33] &= 0xFF;
        } else {
      ...
      case 527739369:
        if (909199331) {
          ...
          b[39] ^= (b[15] + b[14] + b[31] + b[23] + b[27] + b[41] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 681218012;
        continue;
      case 527973694:
        if (739335238) {
          b[16] -= b[1] + b[5] + b[4] + b[37] + b[27] + b[43] + Math.floor( ret_random() * 256);
          b[16] &= 0xFF;
        } else {
      ...
      case 528361686:
        if (96633358n) {
          ...
          b[38] -= b[22] + b[26] + b[9] + b[29] + b[40] + b[1] + Math.floor( ret_random() * 256);
          b[38] &= 0xFF;
        }
        state = 527147759;
        continue;
      ...
      case 533103436:
        if (65086260n) {
          ...
          b[36] += b[1] + b[30] + b[11] + b[22] + b[16] + b[14] + Math.floor( ret_random() * 256);
          b[36] &= 0xFF;
        }
        state = 1055933180;
        continue;
      ...
      case 535029726:
        if (712958263) {
          ...
          b[42] ^= (b[43] + b[39] + b[36] + b[3] + b[26] + b[23] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 366542916;
        continue;
      case 536345467:
      ...
      case 537237003:
        if (33162942n) {
          b[13] ^= (b[1] + b[38] + b[24] + b[40] + b[35] + b[2] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[24] += b[39] + b[14] + b[26] + b[12] + b[13] + b[41] + Math.floor( ret_random() * 256);
          b[24] &= 0xFF;
        }
        state = 890665433;
        continue;
      ...
      case 540405567:
        if (10151601n) {
          ...
          b[6] -= b[20] + b[13] + b[31] + b[26] + b[43] + b[7] + Math.floor( ret_random() * 256);
          b[6] &= 0xFF;
        }
        state = 689542006;
        continue;
      ...
      case 542039106:
        if (1062580192) {
          b[28] ^= (b[13] + b[3] + b[36] + b[26] + b[40] + b[16] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 542432804:
        if (63018993n) {
          ...
          b[16] += b[7] + b[19] + b[39] + b[4] + b[36] + b[34] + Math.floor( ret_random() * 256);
          b[16] &= 0xFF;
        }
        state = 1037670780;
        continue;
      ...
      case 547061522:
        if (775060694) {
          b[33] -= b[32] + b[19] + b[4] + b[28] + b[11] + b[15] + Math.floor( ret_random() * 256);
          b[33] &= 0xFF;
        } else {
      ...
      case 554560760:
        if (318838448) {
          ...
          b[33] -= b[34] + b[30] + b[39] + b[37] + b[13] + b[4] + Math.floor( ret_random() * 256);
          b[33] &= 0xFF;
        }
        state = 686518099;
        continue;
      case 554792969:
        if ( Aret_random() < 0.5) {
          b[34] -= b[37] + b[2] + b[43] + b[28] + b[16] + b[30] + Math.floor( Bret_random() * 256);
          b[34] &= 0xFF;
        } else {
          b[43] += b[26] + b[31] + b[27] + b[15] + b[3] + b[2] + Math.floor( Bret_random() * 256);
          b[43] &= 0xFF;
        }
        state = 35618104;
        continue;
      ...
      case 556468793:
        if (89742293n) {
          b[42] ^= (b[39] + b[34] + b[12] + b[22] + b[19] + b[7] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 558792733:
        if (687814616) {
          ...
          b[14] -= b[20] + b[11] + b[21] + b[38] + b[28] + b[6] + Math.floor( ret_random() * 256);
          b[14] &= 0xFF;
        }
        state = 674074337;
        continue;
      case 560046327:
        if ( Aret_random() < 0.5) {
          b[28] += b[0] + b[37] + b[38] + b[2] + b[14] + b[35] + Math.floor( Bret_random() * 256);
          b[28] &= 0xFF;
        } else {
          b[5] -= b[25] + b[38] + b[18] + b[34] + b[24] + b[20] + Math.floor( Bret_random() * 256);
          b[5] &= 0xFF;
        }
        state = 254183340;
        continue;
      ...
      case 561687718:
        if ( Aret_random() < 0.5) {
          b[7] += b[19] + b[32] + b[13] + b[29] + b[35] + b[43] + Math.floor( Bret_random() * 256);
          b[7] &= 0xFF;
        } else {
      ...
      case 562103074:
        if ( Aret_random() < 0.5) {
          ...
          b[28] ^= (b[40] + b[17] + b[20] + b[35] + b[1] + b[6] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 317299350;
        continue;
      case 562827068:
      ...
      case 564468417:
        if ( Aret_random() < 0.5) {
          b[21] -= b[30] + b[35] + b[32] + b[5] + b[27] + b[41] + Math.floor( Bret_random() * 256);
          b[21] &= 0xFF;
        } else {
      ...
      case 565632760:
        if (339196849) {
          ...
          b[17] ^= (b[21] + b[31] + b[9] + b[10] + b[1] + b[18] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 563121711;
        continue;
      case 566073241:
      ...
      case 572264589:
        if (166324608) {
          b[15] ^= (b[24] + b[23] + b[35] + b[30] + b[27] + b[21] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[29] += b[42] + b[12] + b[2] + b[24] + b[6] + b[39] + Math.floor( ret_random() * 256);
          b[29] &= 0xFF;
        }
        state = 447942078;
        continue;
      case 572340455:
        if ( Aret_random() < 0.5) {
          b[18] -= b[22] + b[24] + b[25] + b[40] + b[27] + b[42] + Math.floor( Bret_random() * 256);
          b[18] &= 0xFF;
        } else {
      ...
      case 574228050:
        if (868513606) {
          b[18] -= b[22] + b[2] + b[36] + b[0] + b[23] + b[10] + Math.floor( ret_random() * 256);
          b[18] &= 0xFF;
        } else {
      ...
      case 576642022:
        if (62603993n) {
          b[3] -= b[39] + b[2] + b[43] + b[24] + b[5] + b[23] + Math.floor( ret_random() * 256);
          b[3] &= 0xFF;
        } else {
      ...
      case 580712029:
        if (899628882) {
          b[16] ^= (b[37] + b[14] + b[38] + b[3] + b[23] + b[31] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 585159232:
        if (76612926n) {
          b[39] += b[6] + b[26] + b[22] + b[12] + b[14] + b[11] + Math.floor( ret_random() * 256);
          b[39] &= 0xFF;
        } else {
      ...
      case 585872335:
        if ( Aret_random() < 0.5) {
          ...
          b[36] -= b[9] + b[3] + b[31] + b[41] + b[8] + b[22] + Math.floor( Bret_random() * 256);
          b[36] &= 0xFF;
        }
        state = 765137136;
        continue;
      ...
      case 586678375:
        if (77156621n) {
          b[11] ^= (b[17] + b[13] + b[40] + b[26] + b[24] + b[8] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[13] ^= (b[41] + b[12] + b[22] + b[28] + b[42] + b[40] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 428507411;
        continue;
      case 588207953:
      ...
      case 588222361:
        if ( Aret_random() < 0.5) {
          b[8] -= b[20] + b[37] + b[25] + b[4] + b[41] + b[38] + Math.floor( Bret_random() * 256);
          b[8] &= 0xFF;
        } else {
      ...
      case 589379043:
        if ( Aret_random() < 0.5) {
          b[33] -= b[21] + b[9] + b[31] + b[6] + b[20] + b[11] + Math.floor( Bret_random() * 256);
          b[33] &= 0xFF;
        } else {
      ...
      case 591243892:
        if (40429544n) {
          ...
          b[24] ^= (b[9] + b[0] + b[28] + b[27] + b[21] + b[33] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 593902528;
        continue;
      case 593231004:
      ...
      case 598167998:
        if (72917820n) {
          b[7] -= b[1] + b[26] + b[15] + b[24] + b[13] + b[31] + Math.floor( ret_random() * 256);
          b[7] &= 0xFF;
        } else {
      ...
      case 598261111:
        if ( Aret_random() < 0.5) {
          ...
          b[7] ^= (b[5] + b[37] + b[18] + b[12] + b[27] + b[21] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 3871500;
        continue;
      case 602845621:
      ...
      case 606417521:
        if (95776195n) {
          ...
          b[29] -= b[10] + b[28] + b[19] + b[38] + b[1] + b[31] + Math.floor( ret_random() * 256);
          b[29] &= 0xFF;
        }
        state = 274960738;
        continue;
      ...
      case 607680747:
        if ( Aret_random() < 0.5) {
          ...
          b[39] -= b[29] + b[17] + b[11] + b[14] + b[37] + b[12] + Math.floor( Bret_random() * 256);
          b[39] &= 0xFF;
        }
        state = 348572019;
        continue;
      ...
      case 610067499:
        if (16096322n) {
          b[7] += b[11] + b[43] + b[13] + b[8] + b[19] + b[23] + Math.floor( ret_random() * 256);
          b[7] &= 0xFF;
        } else {
      ...
      case 610287656:
        if ( Aret_random() < 0.5) {
          ...
          b[2] ^= (b[15] + b[40] + b[14] + b[19] + b[8] + b[25] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 386676293;
        continue;
      case 610501194:
        if (483948646) {
          b[0] -= b[18] + b[32] + b[30] + b[39] + b[37] + b[1] + Math.floor( ret_random() * 256);
          b[0] &= 0xFF;
        } else {
          b[41] -= b[13] + b[30] + b[12] + b[1] + b[22] + b[16] + Math.floor( ret_random() * 256);
          b[41] &= 0xFF;
        }
        state = 444526998;
        continue;
      case 610772468:
        if ( Aret_random() < 0.5) {
          ...
          b[0] ^= (b[21] + b[1] + b[27] + b[17] + b[8] + b[31] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 926668633;
        continue;
      case 613252913:
      ...
      case 613597816:
        if (206260547) {
          ...
          b[42] -= b[36] + b[41] + b[12] + b[21] + b[19] + b[23] + Math.floor( ret_random() * 256);
          b[42] &= 0xFF;
        }
        state = 786401873;
        continue;
      case 613821870:
        if ( Aret_random() < 0.5) {
          ...
          b[28] -= b[13] + b[38] + b[12] + b[17] + b[7] + b[22] + Math.floor( Bret_random() * 256);
          b[28] &= 0xFF;
        }
        state = 538093015;
        continue;
      ...
      case 618349901:
        if (26484079n) {
          b[11] ^= (b[24] + b[26] + b[20] + b[28] + b[15] + b[35] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 619255339:
        if ( Aret_random() < 0.5) {
          ...
          b[34] -= b[30] + b[17] + b[38] + b[41] + b[5] + b[42] + Math.floor( Bret_random() * 256);
          b[34] &= 0xFF;
        }
        state = 562829538;
        continue;
      case 620144002:
        if (575631725) {
          b[11] += b[24] + b[43] + b[29] + b[7] + b[35] + b[20] + Math.floor( ret_random() * 256);
          b[11] &= 0xFF;
        } else {
          b[40] ^= (b[35] + b[22] + b[9] + b[31] + b[23] + b[12] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 188924010;
        continue;
      case 623102886:
      ...
      case 624024080:
        if ( Aret_random() < 0.5) {
          ...
          b[22] += b[41] + b[21] + b[8] + b[10] + b[27] + b[31] + Math.floor( Bret_random() * 256);
          b[22] &= 0xFF;
        }
        state = 1036651800;
        continue;
      case 624483777:
        if ( Aret_random() < 0.5) {
          b[12] += b[18] + b[2] + b[17] + b[7] + b[41] + b[32] + Math.floor( Bret_random() * 256);
          b[12] &= 0xFF;
        } else {
      ...
      case 627583527:
        if ( Aret_random() < 0.5) {
          ...
          b[35] ^= (b[14] + b[24] + b[26] + b[32] + b[7] + b[19] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 358665688;
        continue;
      case 627838396:
        if ( Aret_random() < 0.5) {
          b[39] += b[26] + b[2] + b[35] + b[11] + b[23] + b[14] + Math.floor( Bret_random() * 256);
          b[39] &= 0xFF;
        } else {
      ...
      case 630925076:
        if (894602643) {
          b[16] ^= (b[5] + b[35] + b[12] + b[29] + b[9] + b[36] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 631842634:
        if (88975787n) {
          ...
          b[41] ^= (b[2] + b[38] + b[5] + b[9] + b[23] + b[31] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 34893457;
        continue;
      case 631991648:
      ...
      case 632677318:
        if (116397922) {
          ...
          b[8] -= b[36] + b[38] + b[6] + b[33] + b[27] + b[32] + Math.floor( ret_random() * 256);
          b[8] &= 0xFF;
        }
        state = 848123506;
        continue;
      case 633013038:
        if ( Aret_random() < 0.5) {
          b[34] += b[6] + b[41] + b[33] + b[2] + b[31] + b[24] + Math.floor( Bret_random() * 256);
          b[34] &= 0xFF;
        } else {
      ...
      case 635066656:
        if (13205359n) {
          ...
          b[36] ^= (b[35] + b[5] + b[6] + b[37] + b[17] + b[4] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 413758209;
        continue;
      case 635490398:
      ...
      case 635714957:
        if (821608104) {
          b[9] -= b[36] + b[23] + b[18] + b[0] + b[17] + b[15] + Math.floor( ret_random() * 256);
          b[9] &= 0xFF;
        } else {
      ...
      case 636356544:
        if ( Aret_random() < 0.5) {
          b[23] -= b[3] + b[28] + b[4] + b[27] + b[25] + b[10] + Math.floor( Bret_random() * 256);
          b[23] &= 0xFF;
        } else {
      ...
      case 638017835:
        if ( Aret_random() < 0.5) {
          ...
          b[15] -= b[36] + b[14] + b[31] + b[0] + b[7] + b[10] + Math.floor( Bret_random() * 256);
          b[15] &= 0xFF;
        }
        state = 688954724;
        continue;
      ...
      case 639015755:
        if ( Aret_random() < 0.5) {
          b[20] -= b[36] + b[42] + b[12] + b[24] + b[10] + b[14] + Math.floor( Bret_random() * 256);
          b[20] &= 0xFF;
        } else {
      ...
      case 639995512:
        if (298240906) {
          b[2] += b[13] + b[43] + b[15] + b[20] + b[31] + b[40] + Math.floor( ret_random() * 256);
          b[2] &= 0xFF;
        } else {
      ...
      case 640695661:
        if (773031528) {
          b[0] -= b[35] + b[27] + b[26] + b[6] + b[37] + b[39] + Math.floor( ret_random() * 256);
          b[0] &= 0xFF;
        } else {
      ...
      case 641186517:
        if ( Aret_random() < 0.5) {
          b[34] -= b[26] + b[0] + b[30] + b[18] + b[29] + b[39] + Math.floor( Bret_random() * 256);
          b[34] &= 0xFF;
        } else {
          b[10] += b[25] + b[0] + b[28] + b[35] + b[5] + b[30] + Math.floor( Bret_random() * 256);
          b[10] &= 0xFF;
        }
        state = 1036876601;
        continue;
      case 641228928:
        if (942556861) {
          ...
          b[14] ^= (b[32] + b[30] + b[20] + b[11] + b[3] + b[41] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 81518900;
        continue;
      case 642986604:
        if ( Aret_random() < 0.5) {
          ...
          b[28] ^= (b[41] + b[26] + b[27] + b[37] + b[21] + b[6] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 800885008;
        continue;
      case 643486477:
        if (59362548n) {
          b[26] += b[7] + b[8] + b[17] + b[31] + b[29] + b[3] + Math.floor( ret_random() * 256);
          b[26] &= 0xFF;
        } else {
          b[22] -= b[43] + b[18] + b[23] + b[42] + b[17] + b[33] + Math.floor( ret_random() * 256);
          b[22] &= 0xFF;
        }
        state = 240796634;
        continue;
      ...
      case 648694757:
        if (35072631n) {
          ...
          b[11] ^= (b[25] + b[14] + b[10] + b[15] + b[23] + b[38] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 439715360;
        continue;
      case 650908334:
        if (632156730) {
          b[1] ^= (b[3] + b[12] + b[11] + b[4] + b[28] + b[31] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[42] ^= (b[12] + b[43] + b[37] + b[6] + b[19] + b[40] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 722855241;
        continue;
      case 651944800:
      ...
      case 652341782:
        if (852347526) {
          b[27] += b[38] + b[37] + b[15] + b[0] + b[19] + b[40] + Math.floor( ret_random() * 256);
          b[27] &= 0xFF;
        } else {
          b[41] += b[25] + b[0] + b[40] + b[8] + b[5] + b[26] + Math.floor( ret_random() * 256);
          b[41] &= 0xFF;
        }
        state = 422798983;
        continue;
      ...
      case 652875761:
        if (416219648) {
          ...
          b[23] ^= (b[17] + b[16] + b[3] + b[30] + b[24] + b[43] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 856977353;
        continue;
      case 653960194:
        if (604879063) {
          ...
          b[43] -= b[40] + b[19] + b[26] + b[4] + b[10] + b[7] + Math.floor( ret_random() * 256);
          b[43] &= 0xFF;
        }
        state = 440659815;
        continue;
      case 654069315:
        if ( Aret_random() < 0.5) {
          b[43] += b[39] + b[2] + b[7] + b[3] + b[24] + b[41] + Math.floor( Bret_random() * 256);
          b[43] &= 0xFF;
        } else {
          b[12] -= b[0] + b[13] + b[28] + b[38] + b[43] + b[1] + Math.floor( Bret_random() * 256);
          b[12] &= 0xFF;
        }
        state = 920953908;
        continue;
      ...
      case 657690603:
        if (50326544n) {
          b[15] += b[28] + b[7] + b[29] + b[13] + b[0] + b[22] + Math.floor( ret_random() * 256);
          b[15] &= 0xFF;
        } else {
      ...
      case 662440992:
        if ( Aret_random() < 0.5) {
          ...
          b[23] -= b[17] + b[34] + b[39] + b[3] + b[21] + b[26] + Math.floor( Bret_random() * 256);
          b[23] &= 0xFF;
        }
        state = 624840521;
        continue;
      ...
      case 665367266:
        if ( Aret_random() < 0.5) {
          b[43] += b[32] + b[34] + b[16] + b[29] + b[39] + b[4] + Math.floor(Bret_random() * 256);
          b[43] &= 0xFF;
        } else {
      ...
      case 667976664:
        if (604457272) {
          b[15] += b[41] + b[29] + b[17] + b[31] + b[37] + b[5] + Math.floor( ret_random() * 256);
          b[15] &= 0xFF;
        } else {
      ...
      case 674866669:
        if (15952499n) {
          b[8] ^= (b[4] + b[13] + b[43] + b[26] + b[9] + b[21] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 676900802:
        if ( Aret_random() < 0.5) {
          ...
          b[30] += b[33] + b[42] + b[2] + b[39] + b[1] + b[14] + Math.floor( Bret_random() * 256);
          b[30] &= 0xFF;
        }
        state = 581381813;
        continue;
      case 679907763:
        if ( Aret_random() < 0.5) {
          ...
          b[20] -= b[34] + b[11] + b[21] + b[0] + b[43] + b[13] + Math.floor( Bret_random() * 256);
          b[20] &= 0xFF;
        }
        state = 91915693;
        continue;
      case 680818939:
        if (14322765) {
          b[20] -= b[37] + b[7] + b[18] + b[1] + b[8] + b[28] + Math.floor( ret_random() * 256);
          b[20] &= 0xFF;
        } else {
          b[9] -= b[18] + b[4] + b[7] + b[13] + b[29] + b[26] + Math.floor( ret_random() * 256);
          b[9] &= 0xFF;
        }
        state = 285191804;
        continue;
      ...
      case 686997760:
        if ( Aret_random() < 0.5) {
          ...
          b[6] ^= (b[14] + b[34] + b[37] + b[12] + b[24] + b[25] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 718964675;
        continue;
      case 687112427:
      ...
      case 690944261:
        if (89710082n) {
          ...
          b[37] += b[28] + b[25] + b[17] + b[43] + b[31] + b[32] + Math.floor( ret_random() * 256);
          b[37] &= 0xFF;
        }
        state = 392099329;
        continue;
      case 691686948:
        if ( Aret_random() < 0.5) {
          ...
          b[16] -= b[38] + b[6] + b[21] + b[34] + b[27] + b[10] + Math.floor( Bret_random() * 256);
          b[16] &= 0xFF;
        }
        state = 154011094;
        continue;
      ...
      case 694178482:
        if ( Aret_random() < 0.5) {
          ...
          b[35] -= b[31] + b[37] + b[38] + b[21] + b[28] + b[11] + Math.floor( Bret_random() * 256);
          b[35] &= 0xFF;
        }
        state = 840687699;
        continue;
      ...
      case 694925458:
        if (430396022) {
          b[9] ^= (b[33] + b[32] + b[2] + b[19] + b[15] + b[36] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 695393418:
        if ( Aret_random() < 0.5) {
          ...
          b[6] -= b[36] + b[29] + b[27] + b[23] + b[3] + b[19] + Math.floor( Bret_random() * 256);
          b[6] &= 0xFF;
        }
        state = 420210625;
        continue;
      case 696914010:
        if (824577734) {
          b[0] ^= (b[32] + b[37] + b[1] + b[18] + b[8] + b[3] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 699096503:
        if (40576212n) {
          ...
          b[39] -= b[0] + b[18] + b[21] + b[22] + b[31] + b[6] + Math.floor( ret_random() * 256);
          b[39] &= 0xFF;
        }
        state = 542565287;
        continue;
      case 700493929:
        if ( Aret_random() < 0.5) {
          b[10] += b[17] + b[25] + b[43] + b[12] + b[30] + b[4] + Math.floor( Bret_random() * 256);
          b[10] &= 0xFF;
        } else {
      ...
      case 703638644:
        if (826923791) {
          b[8] += b[17] + b[31] + b[30] + b[19] + b[40] + b[39] + Math.floor( ret_random() * 256);
          b[8] &= 0xFF;
        } else {
      ...
      case 706248766:
        if ( Aret_random() < 0.5) {
          ...
          b[25] -= b[6] + b[4] + b[7] + b[3] + b[26] + b[12] + Math.floor( Bret_random() * 256);
          b[25] &= 0xFF;
        }
        state = 40024592;
        continue;
      ...
      case 714437222:
        if ( Aret_random() < 0.5) {
          ...
          b[9] -= b[17] + b[34] + b[18] + b[26] + b[42] + b[13] + Math.floor( Bret_random() * 256);
          b[9] &= 0xFF;
        }
        state = 908578754;
        continue;
      case 715652268:
        if ( Aret_random() < 0.5) {
          ...
          b[26] += b[6] + b[10] + b[7] + b[2] + b[11] + b[32] + Math.floor( Bret_random() * 256);
          b[26] &= 0xFF;
        }
        state = 16449040;
        continue;
      ...
      case 717447985:
        if (781719997) {
          b[22] += b[27] + b[41] + b[18] + b[36] + b[2] + b[3] + Math.floor( ret_random() * 256);
          b[22] &= 0xFF;
        } else {
      ...
      case 718295275:
        if (869773898) {
          b[23] ^= (b[12] + b[4] + b[31] + b[42] + b[35] + b[41] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 719604778:
        if (48467378n) {
          ...
          b[14] ^= (b[25] + b[4] + b[33] + b[9] + b[17] + b[0] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 394356229;
        continue;
      case 721440911:
      ...
      case 721721344:
        if (12408061n) {
          b[13] -= b[31] + b[43] + b[26] + b[41] + b[24] + b[42] + Math.floor( ret_random() * 256);
          b[13] &= 0xFF;
        } else {
          b[9] -= b[21] + b[0] + b[27] + b[6] + b[36] + b[24] + Math.floor( ret_random() * 256);
          b[9] &= 0xFF;
        }
        state = 906715513;
        continue;
      case 724665382:
        if ( Aret_random() < 0.5) {
          ...
          b[9] -= b[5] + b[43] + b[42] + b[7] + b[1] + b[28] + Math.floor( Bret_random() * 256);
          b[9] &= 0xFF;
        }
        state = 711141192;
        continue;
      ...
      case 726887314:
        if (589762261) {
          ...
          b[43] ^= (b[34] + b[28] + b[20] + b[31] + b[7] + b[5] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 451022489;
        continue;
      case 727581920:
      ...
      case 737600074:
        if ( Aret_random() < 0.5) {
          b[34] += b[19] + b[7] + b[18] + b[17] + b[31] + b[23] + Math.floor( Bret_random() * 256);
          b[34] &= 0xFF;
        } else {
      ...
      case 738349727:
        if (1029881146) {
          ...
          b[39] ^= (b[9] + b[18] + b[20] + b[15] + b[40] + b[10] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 260627984;
        continue;
      case 738393887:
      ...
      case 741568164:
        if (161224872) {
          ...
          b[2] ^= (b[1] + b[40] + b[32] + b[37] + b[21] + b[35] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 1024767413;
        continue;
      case 742853454:
      ...
      case 742863292:
        if (60469374n) {
          b[21] ^= (b[12] + b[43] + b[41] + b[37] + b[11] + b[26] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 753140202:
        if (66254653n) {
          b[9] ^= (b[12] + b[1] + b[11] + b[33] + b[4] + b[8] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 759656823:
        if (505461787) {
          ...
          b[27] -= b[13] + b[14] + b[35] + b[37] + b[23] + b[31] + Math.floor( ret_random() * 256);
          b[27] &= 0xFF;
        }
        state = 946348328;
        continue;
      ...
      case 761621198:
        if ( Aret_random() < 0.5) {
          b[8] -= b[41] + b[24] + b[2] + b[6] + b[1] + b[31] + Math.floor( Bret_random() * 256);
          b[8] &= 0xFF;
        } else {
      ...
      case 764848634:
        if (25710910n) {
          ...
          b[16] ^= (b[14] + b[5] + b[24] + b[39] + b[36] + b[29] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 456603755;
        continue;
      case 767096117:
      ...
      case 769036486:
        if ( Aret_random() < 0.5) {
          b[36] -= b[16] + b[12] + b[10] + b[32] + b[19] + b[5] + Math.floor( Bret_random() * 256);
          b[36] &= 0xFF;
        } else {
      ...
      case 770907936:
        if ( Aret_random() < 0.5) {
          b[43] -= b[8] + b[39] + b[2] + b[40] + b[37] + b[10] + Math.floor( Bret_random() * 256);
          b[43] &= 0xFF;
        } else {
      ...
      case 772657164:
        if ( Aret_random() < 0.5) {
          ...
          b[11] ^= (b[25] + b[18] + b[38] + b[35] + b[39] + b[34] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 392668663;
        continue;
      case 772702548:
      ...
      case 773635926:
        if (825147063) {
          ...
          b[40] ^= (b[30] + b[32] + b[11] + b[24] + b[2] + b[7] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 616957437;
        continue;
      case 776373276:
        if (423205447) {
          ...
          b[21] -= b[39] + b[6] + b[0] + b[33] + b[8] + b[40] + Math.floor( ret_random() * 256);
          b[21] &= 0xFF;
        }
        state = 1006005727;
        continue;
      case 779328580:
        if (1022791685) {
          b[18] ^= (b[35] + b[0] + b[8] + b[16] + b[1] + b[6] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[40] ^= (b[30] + b[28] + b[20] + b[33] + b[9] + b[22] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 778837714;
        continue;
      case 779958856:
      ...
      case 780429714:
        if (19238184n) {
          b[26] ^= (b[40] + b[39] + b[1] + b[36] + b[4] + b[42] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 780480466:
        if (869806366) {
          b[32] -= b[41] + b[27] + b[17] + b[38] + b[9] + b[25] + Math.floor( ret_random() * 256);
          b[32] &= 0xFF;
        } else {
      ...
      case 781937258:
        if (540383326) {
          b[28] += b[40] + b[3] + b[32] + b[34] + b[42] + b[20] + Math.floor( ret_random() * 256);
          b[28] &= 0xFF;
        } else {
          b[41] ^= (b[31] + b[36] + b[2] + b[42] + b[43] + b[4] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 897885654;
        continue;
      case 784248654:
        if (8301924) {
          ...
          b[6] -= b[43] + b[35] + b[2] + b[27] + b[21] + b[30] + Math.floor( ret_random() * 256);
          b[6] &= 0xFF;
        }
        state = 125306521;
        continue;
      case 784551218:
        if (62812649n) {
          b[21] ^= (b[32] + b[23] + b[39] + b[17] + b[33] + b[29] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 784888727:
        if (378672444) {
          b[25] ^= (b[37] + b[5] + b[4] + b[7] + b[38] + b[26] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 787067102:
        if (17308771n) {
          b[22] += b[13] + b[6] + b[1] + b[23] + b[43] + b[32] + Math.floor( ret_random() * 256);
          b[22] &= 0xFF;
        } else {
          b[14] -= b[23] + b[0] + b[10] + b[42] + b[38] + b[2] + Math.floor( ret_random() * 256);
          b[14] &= 0xFF;
        }
        state = 976615861;
        continue;
      case 789883991:
        if ( Aret_random() < 0.5) {
          b[17] -= b[26] + b[12] + b[4] + b[18] + b[29] + b[25] + Math.floor( Bret_random() * 256);
          b[17] &= 0xFF;
        } else {
          b[41] ^= (b[2] + b[1] + b[19] + b[17] + b[15] + b[3] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 965410634;
        continue;
      case 790738357:
      ...
      case 791903896:
        if (64085983n) {
          b[18] -= b[39] + b[9] + b[29] + b[33] + b[32] + b[3] + Math.floor( ret_random() * 256);
          b[18] &= 0xFF;
        } else {
      ...
      case 793300376:
        if (56756954n) {
          ...
          b[43] -= b[11] + b[15] + b[33] + b[35] + b[21] + b[25] + Math.floor( ret_random() * 256);
          b[43] &= 0xFF;
        }
        state = 1039563113;
        continue;
      case 793788927:
        if (26014551n) {
          b[26] += b[18] + b[1] + b[32] + b[39] + b[0] + b[7] + Math.floor( ret_random() * 256);
          b[26] &= 0xFF;
        } else {
      ...
      case 797141609:
        if ( Aret_random() < 0.5) {
          b[18] += b[8] + b[33] + b[11] + b[36] + b[25] + b[31] + Math.floor( Bret_random() * 256);
          b[18] &= 0xFF;
        } else {
      ...
      case 797360669:
        if (58321764n) {
          ...
          b[1] -= b[14] + b[33] + b[4] + b[34] + b[13] + b[18] + Math.floor( ret_random() * 256);
          b[1] &= 0xFF;
        }
        state = 112359771;
        continue;
      ...
      case 797748313:
        if ( Aret_random() < 0.5) {
          ...
          b[22] ^= (b[26] + b[31] + b[9] + b[15] + b[14] + b[17] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 1017282126;
        continue;
      case 798743267:
        if (923972252) {
          ...
          b[33] -= b[27] + b[9] + b[21] + b[38] + b[23] + b[5] + Math.floor( ret_random() * 256);
          b[33] &= 0xFF;
        }
        state = 663527695;
        continue;
      ...
      case 805377128:
        if (79102690n) {
          ...
          b[5] -= b[21] + b[2] + b[19] + b[16] + b[6] + b[23] + Math.floor( ret_random() * 256);
          b[5] &= 0xFF;
        }
        state = 382251608;
        continue;
      ...
      case 813144274:
        if (640866493) {
          ...
          b[0] -= b[37] + b[26] + b[14] + b[22] + b[21] + b[12] + Math.floor( ret_random() * 256);
          b[0] &= 0xFF;
        }
        state = 303626156;
        continue;
      case 813512048:
        if (73234172n) {
          ...
          b[4] ^= (b[42] + b[18] + b[12] + b[5] + b[16] + b[37] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 1033659483;
        continue;
      case 814323669:
      ...
      case 818877870:
        if (779676322) {
          b[14] += b[35] + b[18] + b[20] + b[33] + b[2] + b[3] + Math.floor( ret_random() * 256);
          b[14] &= 0xFF;
        } else {
      ...
      case 824267648:
        if (78309846n) {
          b[22] += b[29] + b[7] + b[32] + b[34] + b[4] + b[36] + Math.floor( ret_random() * 256);
          b[22] &= 0xFF;
        } else {
          b[30] += b[22] + b[29] + b[18] + b[17] + b[35] + b[6] + Math.floor( ret_random() * 256);
          b[30] &= 0xFF;
        }
        state = 605829637;
        continue;
      ...
      case 832291230:
        if ( Aret_random() < 0.5) {
          b[0] += b[34] + b[3] + b[41] + b[28] + b[29] + b[36] + Math.floor( Bret_random() * 256);
          b[0] &= 0xFF;
        } else {
      ...
      case 839201324:
        if ( Aret_random() < 0.5) {
          b[9] -= b[27] + b[19] + b[33] + b[24] + b[10] + b[17] + Math.floor( Bret_random() * 256);
          b[9] &= 0xFF;
        } else {
      ...
      case 846465521:
        if ( Aret_random() < 0.5) {
          b[25] += b[16] + b[15] + b[13] + b[24] + b[3] + b[7] + Math.floor( Bret_random() * 256);
          b[25] &= 0xFF;
        } else {
      ...
      case 847448000:
        if ( Aret_random() < 0.5) {
          ...
          b[19] -= b[26] + b[27] + b[29] + b[32] + b[14] + b[21] + Math.floor( Bret_random() * 256);
          b[19] &= 0xFF;
        }
        state = 1029815228;
        continue;
      ...
      case 852370076:
        if (51835112n) {
          b[6] += b[27] + b[26] + b[3] + b[13] + b[32] + b[20] + Math.floor( ret_random() * 256);
          b[6] &= 0xFF;
        } else {
      ...
      case 857076787:
        if ( Aret_random() < 0.5) {
          b[7] ^= (b[29] + b[41] + b[34] + b[9] + b[32] + b[16] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 860260968:
        if (913529630) {
          b[41] += b[2] + b[12] + b[28] + b[9] + b[16] + b[26] + Math.floor( ret_random() * 256);
          b[41] &= 0xFF;
        } else {
      ...
      case 861726887:
        if ( Aret_random() < 0.5) {
          b[24] -= b[8] + b[33] + b[10] + b[36] + b[18] + b[11] + Math.floor( Bret_random() * 256);
          b[24] &= 0xFF;
        } else {
      ...
      case 862632486:
        if (986135796) {
          b[43] ^= (b[13] + b[8] + b[35] + b[18] + b[2] + b[32] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[0] ^= (b[40] + b[36] + b[42] + b[23] + b[17] + b[34] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 1073280106;
        continue;
      case 864991412:
        if (995008496) {
          b[17] -= b[15] + b[38] + b[2] + b[35] + b[34] + b[39] + Math.floor( ret_random() * 256);
          b[17] &= 0xFF;
        } else {
      ...
      case 867656279:
        if (47870775n) {
          b[3] += b[34] + b[43] + b[8] + b[1] + b[14] + b[30] + Math.floor( ret_random() * 256);
          b[3] &= 0xFF;
        } else {
      ...
      case 880735562:
        if (864008641) {
          b[5] -= b[1] + b[24] + b[18] + b[34] + b[43] + b[8] + Math.floor( ret_random() * 256);
          b[5] &= 0xFF;
        } else {
      ...
      case 881848114:
        if (185191464) {
          b[40] += b[39] + b[30] + b[4] + b[41] + b[38] + b[35] + Math.floor( ret_random() * 256);
          b[40] &= 0xFF;
        } else {
      ...
      case 882184715:
        if (70257542n) {
          ...
          b[18] += b[30] + b[35] + b[15] + b[41] + b[34] + b[22] + Math.floor( ret_random() * 256);
          b[18] &= 0xFF;
        }
        state = 573249288;
        continue;
      ...
      case 887720569:
        if (955008247) {
          b[11] += b[42] + b[26] + b[29] + b[30] + b[33] + b[0] + Math.floor( ret_random() * 256);
          b[11] &= 0xFF;
        } else {
      ...
      case 891821885:
        if (639214279) {
          b[21] ^= (b[27] + b[13] + b[17] + b[34] + b[40] + b[14] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 895117942:
        if (700243138) {
          b[33] += b[16] + b[2] + b[43] + b[1] + b[35] + b[34] + Math.floor( ret_random() * 256);
          b[33] &= 0xFF;
        } else {
      ...
      case 895572296:
        if ( Aret_random() < 0.5) {
          b[15] ^= (b[12] + b[27] + b[32] + b[35] + b[40] + b[0] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 897152026:
        if (83052088) {
          ...
          b[8] -= b[12] + b[16] + b[14] + b[4] + b[34] + b[23] + Math.floor( ret_random() * 256);
          b[8] &= 0xFF;
        }
        state = 386052172;
        continue;
      case 897254511:
        if (99197999n) {
          b[0] += b[13] + b[33] + b[34] + b[27] + b[21] + b[24] + Math.floor( ret_random() * 256);
          b[0] &= 0xFF;
        } else {
      ...
      case 897843229:
        if (378121307) {
          ...
          b[29] ^= (b[14] + b[1] + b[18] + b[20] + b[17] + b[34] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 662540068;
        continue;
      case 898171258:
      ...
      case 899930749:
        if ( Aret_random() < 0.5) {
          b[11] ^= (b[2] + b[21] + b[40] + b[42] + b[43] + b[35] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 900576857:
        if (238361334) {
          b[34] -= b[42] + b[11] + b[1] + b[19] + b[4] + b[18] + Math.floor( ret_random() * 256);
          b[34] &= 0xFF;
        } else {
      ...
      case 900739574:
        if (16520121n) {
          b[32] -= b[7] + b[37] + b[29] + b[16] + b[3] + b[25] + Math.floor( ret_random() * 256);
          b[32] &= 0xFF;
        } else {
      ...
      case 901371023:
        if (222235966) {
          b[12] ^= (b[34] + b[26] + b[5] + b[32] + b[36] + b[8] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 903508757:
        if (788010403) {
          ...
          b[42] ^= (b[14] + b[6] + b[29] + b[16] + b[10] + b[43] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 66245927;
        continue;
      case 906680424:
      ...
      case 907717109:
        if (895984808) {
          b[7] ^= (b[23] + b[8] + b[16] + b[39] + b[31] + b[34] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[25] ^= (b[43] + b[5] + b[32] + b[38] + b[35] + b[21] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 556046909;
        continue;
      case 908446718:
      ...
      case 916699096:
        if (76348309n) {
          ...
          b[27] ^= (b[30] + b[19] + b[18] + b[23] + b[11] + b[25] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 705074829;
        continue;
      case 917008021:
        if (311158600) {
          ...
          b[35] ^= (b[1] + b[29] + b[25] + b[5] + b[16] + b[10] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 386755595;
        continue;
      case 922049847:
      ...
      case 923850245:
        if (72387310n) {
          ...
          b[26] ^= (b[19] + b[37] + b[12] + b[22] + b[43] + b[25] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 873425347;
        continue;
      case 923876614:
      ...
      case 925520064:
        if ( Aret_random() < 0.5) {
          ...
          b[36] -= b[6] + b[21] + b[18] + b[31] + b[15] + b[7] + Math.floor( Bret_random() * 256);
          b[36] &= 0xFF;
        }
        state = 212640615;
        continue;
      ...
      case 930229865:
        if (187629038) {
          b[21] += b[12] + b[42] + b[26] + b[13] + b[27] + b[3] + Math.floor( ret_random() * 256);
          b[21] &= 0xFF;
        } else {
      ...
      case 934739973:
        if ( Aret_random() < 0.5) {
          b[20] -= b[7] + b[37] + b[5] + b[0] + b[34] + b[17] + Math.floor( Bret_random() * 256);
          b[20] &= 0xFF;
        } else {
          b[35] += b[25] + b[23] + b[41] + b[26] + b[0] + b[20] + Math.floor( Bret_random() * 256);
          b[35] &= 0xFF;
        }
        state = 1064137877;
        continue;
      ...
      case 934956011:
        if (812385208) {
          ...
          b[19] += b[38] + b[31] + b[9] + b[35] + b[29] + b[39] + Math.floor( ret_random() * 256);
          b[19] &= 0xFF;
        }
        state = 296633824;
        continue;
      case 935030589:
        if (750736072) {
          ...
          b[10] -= b[15] + b[21] + b[0] + b[42] + b[31] + b[9] + Math.floor( ret_random() * 256);
          b[10] &= 0xFF;
        }
        state = 894072943;
        continue;
      case 936214335:
        if (92001583n) {
          ...
          b[24] ^= (b[29] + b[1] + b[2] + b[21] + b[31] + b[9] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 865297185;
        continue;
      case 938822551:
      ...
      case 940416943:
        if (63696991n) {
          b[12] ^= (b[7] + b[28] + b[36] + b[42] + b[17] + b[13] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 940887364:
        if (981305315) {
          ...
          b[24] += b[37] + b[42] + b[7] + b[5] + b[22] + b[11] + Math.floor( ret_random() * 256);
          b[24] &= 0xFF;
        }
        state = 202412843;
        continue;
      ...
      case 943408141:
        if (813203056) {
          ...
          b[0] ^= (b[11] + b[37] + b[33] + b[36] + b[38] + b[3] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 1071572916;
        continue;
      case 943451716:
      ...
      case 950500871:
        if (72963199n) {
          b[25] -= b[33] + b[17] + b[37] + b[34] + b[43] + b[40] + Math.floor( ret_random() * 256);
          b[25] &= 0xFF;
        } else {
      ...
      case 957436102:
        if ( Aret_random() < 0.5) {
          ...
          b[28] ^= (b[1] + b[23] + b[37] + b[31] + b[43] + b[42] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 10023459;
        continue;
      case 958174320:
      ...
      case 960357655:
        if (32760615) {
          ...
          b[15] ^= (b[20] + b[3] + b[36] + b[7] + b[9] + b[39] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 653166564;
        continue;
      case 960991331:
      ...
      case 961374201:
        if (56599935n) {
          ...
          b[21] += b[20] + b[13] + b[41] + b[1] + b[7] + b[33] + Math.floor( ret_random() * 256);
          b[21] &= 0xFF;
        }
        state = 828519420;
        continue;
      case 961924244:
        if ( Aret_random() < 0.5) {
          b[6] -= b[34] + b[1] + b[29] + b[26] + b[39] + b[22] + Math.floor( Bret_random() * 256);
          b[6] &= 0xFF;
        } else {
      ...
      case 963449270:
        if ( Aret_random() < 0.5) {
          b[14] -= b[40] + b[33] + b[29] + b[36] + b[20] + b[42] + Math.floor( Bret_random() * 256);
          b[14] &= 0xFF;
        } else {
      ...
      case 965766581:
        if ( Aret_random() < 0.5) {
          ...
          b[35] += b[32] + b[36] + b[9] + b[17] + b[37] + b[26] + Math.floor( Bret_random() * 256);
          b[35] &= 0xFF;
        }
        state = 408850718;
        continue;
      case 967654317:
        if (580972453) {
          b[21] += b[25] + b[31] + b[39] + b[24] + b[17] + b[18] + Math.floor( ret_random() * 256);
          b[21] &= 0xFF;
        } else {
      ...
      case 968134268:
        if (90448955n) {
          ...
          b[20] ^= (b[0] + b[17] + b[24] + b[37] + b[2] + b[6] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 163298870;
        continue;
      case 968337128:
      ...
      case 972593536:
        if (19020555n) {
          ...
          b[4] -= b[30] + b[14] + b[36] + b[32] + b[20] + b[0] + Math.floor( ret_random() * 256);
          b[4] &= 0xFF;
        }
        state = 172583856;
        continue;
      ...
      case 980186436:
        if (66114638n) {
          ...
          b[9] += b[10] + b[18] + b[25] + b[31] + b[7] + b[40] + Math.floor( ret_random() * 256);
          b[9] &= 0xFF;
        }
        state = 1021362401;
        continue;
      case 980801854:
        if ( Aret_random() < 0.5) {
          b[41] ^= (b[28] + b[7] + b[11] + b[8] + b[20] + b[9] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 984396248:
        if ( Aret_random() < 0.5) {
          ...
          b[15] += b[21] + b[27] + b[36] + b[40] + b[37] + b[20] + Math.floor( Bret_random() * 256);
          b[15] &= 0xFF;
        }
        state = 958145418;
        continue;
      ...
      case 987447585:
        if (31410266n) {
          ...
          b[24] += b[5] + b[29] + b[33] + b[1] + b[0] + b[6] + Math.floor( ret_random() * 256);
          b[24] &= 0xFF;
        }
        state = 346635123;
        continue;
      ...
      case 996305121:
        if (995188177) {
          b[38] -= b[18] + b[4] + b[27] + b[25] + b[14] + b[40] + Math.floor( ret_random() * 256);
          b[38] &= 0xFF;
        } else {
          b[11] += b[24] + b[9] + b[13] + b[33] + b[39] + b[22] + Math.floor( ret_random() * 256);
          b[11] &= 0xFF;
        }
        state = 64857213;
        continue;
      case 996361116:
        if ( Aret_random() < 0.5) {
          ...
          b[40] += b[22] + b[0] + b[28] + b[17] + b[31] + b[11] + Math.floor( Bret_random() * 256);
          b[40] &= 0xFF;
        }
        state = 269458850;
        continue;
      case 998309844:
        if (253411493) {
          b[23] += b[2] + b[1] + b[25] + b[31] + b[10] + b[41] + Math.floor( ret_random() * 256);
          b[23] &= 0xFF;
        } else {
      ...
      case 999324458:
        if (112278826) {
          ...
          b[7] += b[30] + b[35] + b[16] + b[23] + b[40] + b[22] + Math.floor( ret_random() * 256);
          b[7] &= 0xFF;
        }
        state = 770651828;
        continue;
      ...
      case 1006204370:
        if (250293893) {
          ...
          b[40] += b[21] + b[3] + b[14] + b[13] + b[20] + b[5] + Math.floor( ret_random() * 256);
          b[40] &= 0xFF;
        }
        state = 639983618;
        continue;
      case 1007745471:
        if (758792626) {
          ...
          b[35] += b[4] + b[29] + b[25] + b[9] + b[6] + b[3] + Math.floor( ret_random() * 256);
          b[35] &= 0xFF;
        }
        state = 754946132;
        continue;
      case 1007784734:
        if (349045045) {
          b[11] -= b[27] + b[31] + b[2] + b[7] + b[43] + b[38] + Math.floor( ret_random() * 256);
          b[11] &= 0xFF;
        } else {
          b[29] ^= (b[24] + b[9] + b[33] + b[36] + b[28] + b[17] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 37958807;
        continue;
      case 1009568819:
        if (163685368) {
          b[41] ^= (b[4] + b[1] + b[25] + b[16] + b[10] + b[33] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 1009817857:
        if (18234293n) {
          ...
          b[40] -= b[1] + b[9] + b[18] + b[17] + b[33] + b[39] + Math.floor( ret_random() * 256);
          b[40] &= 0xFF;
        }
        state = 916573862;
        continue;
      ...
      case 1010356043:
        console.log(arr[i]);
        if ( Aret_random() < 0.5) {
          b[42] -= b[4] + b[5] + b[35] + b[12] + b[22] + b[19] + Math.floor( Bret_random() * 256);
          b[42] &= 0xFF;
        } else {
      ...
      case 1012665353:
        if (270968034) {
          ...
          b[1] -= b[4] + b[25] + b[41] + b[21] + b[22] + b[10] + Math.floor( ret_random() * 256);
          b[1] &= 0xFF;
        }
        state = 567106632;
        continue;
      case 1013605951:
        if ( Aret_random() < 0.5) {
          ...
          b[23] += b[30] + b[36] + b[5] + b[7] + b[22] + b[39] + Math.floor( Bret_random() * 256);
          b[23] &= 0xFF;
        }
        state = 1014671117;
        continue;
      ...
      case 1020638245:
        if (341042742) {
          ...
          b[8] += b[41] + b[23] + b[11] + b[17] + b[5] + b[39] + Math.floor( ret_random() * 256);
          b[8] &= 0xFF;
        }
        state = 656679814;
        continue;
      case 1020799775:
        if (71122535n) {
          ...
          b[42] ^= (b[25] + b[34] + b[32] + b[0] + b[5] + b[17] + Math.floor( ret_random() * 256)) & 0xFF;
        }
        state = 413962209;
        continue;
      case 1021595414:
        if ( Aret_random() < 0.5) {
          b[26] -= b[2] + b[21] + b[0] + b[40] + b[5] + b[24] + Math.floor( Bret_random() * 256);
          b[26] &= 0xFF;
        } else {
      ...
      case 1022867386:
        if (971264745) {
          b[38] ^= (b[25] + b[17] + b[43] + b[42] + b[14] + b[8] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 1023914457:
        if ( Aret_random() < 0.5) {
          ...
          b[30] ^= (b[16] + b[40] + b[42] + b[32] + b[2] + b[41] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 448550515;
        continue;
      case 1025916139:
      ...
      case 1027336899:
        if ( Aret_random() < 0.5) {
          b[18] += b[21] + b[5] + b[40] + b[34] + b[43] + b[41] + Math.floor( Bret_random() * 256);
          b[18] &= 0xFF;
        } else {
      ...
      case 1027590517:
        if (896562078) {
          ...
          b[43] -= b[32] + b[27] + b[4] + b[25] + b[8] + b[11] + Math.floor( ret_random() * 256);
          b[43] &= 0xFF;
        }
        state = 198957017;
        continue;
      ...
      case 1030774184:
        if (869017612) {
          b[36] ^= (b[34] + b[23] + b[11] + b[39] + b[1] + b[41] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 1031385455:
        if (71620143n) {
          b[14] ^= (b[0] + b[7] + b[13] + b[39] + b[21] + b[22] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
      ...
      case 1032477597:
        if (80270086n) {
          ...
          b[36] += b[38] + b[17] + b[14] + b[26] + b[32] + b[40] + Math.floor( ret_random() * 256);
          b[36] &= 0xFF;
        }
        state = 1030500729;
        continue;
      case 1032623622:
        if ( Aret_random() < 0.5) {
          ...
          b[5] += b[19] + b[9] + b[32] + b[7] + b[18] + b[24] + Math.floor( Bret_random() * 256);
          b[5] &= 0xFF;
        }
        state = 220941052;
        continue;
      ...
      case 1048216731:
        if (77511183n) {
          ...
          b[22] -= b[16] + b[18] + b[7] + b[23] + b[1] + b[27] + Math.floor( ret_random() * 256);
          b[22] &= 0xFF;
          //console.log(arr[i]);
        }
        state = 598763014;
      ...
      case 1050297000:
        if ( Aret_random() < 0.5) {
          ...
          b[0] ^= (b[19] + b[7] + b[16] + b[35] + b[25] + b[17] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 1038369278;
        continue;
      case 1051637796:
        if (709602957) {
          b[31] += b[40] + b[17] + b[29] + b[22] + b[23] + b[7] + Math.floor( ret_random() * 256);
          b[31] &= 0xFF;
        } else {
          b[11] -= b[43] + b[37] + b[41] + b[18] + b[29] + b[33] + Math.floor( ret_random() * 256);
          b[11] &= 0xFF;
        }
        state = 427285211;
        continue;
      ...
      case 1058172980:
        if ( Aret_random() < 0.5) {
          b[40] += b[17] + b[26] + b[34] + b[13] + b[27] + b[6] + Math.floor( Bret_random() * 256);
          b[40] &= 0xFF;
        } else {
      ...
      case 1060070784:
        if ( Aret_random() < 0.5) {
          b[9] ^= (b[43] + b[21] + b[32] + b[33] + b[25] + b[42] + Math.floor( Bret_random() * 256)) & 0xFF;
        } else {
      ...
      case 1066734042:
        if (769282608) {
          b[25] ^= (b[42] + b[5] + b[6] + b[12] + b[15] + b[22] + Math.floor( ret_random() * 256)) & 0xFF;
        } else {
          b[6] -= b[4] + b[40] + b[15] + b[37] + b[12] + b[23] + Math.floor( ret_random() * 256);
          b[6] &= 0xFF;
        }
        state = 826829071;
        continue;
      ...
      case 1067938463:
        if (722589847) {
          ...
          b[40] += b[2] + b[17] + b[26] + b[8] + b[24] + b[23] + Math.floor( ret_random() * 256);
          b[40] &= 0xFF;
        }
        state = 382387218;
        continue;
      ...
      case 1069471290:
        if ( Aret_random() < 0.5) {
          b[39] += b[30] + b[27] + b[6] + b[31] + b[13] + b[42] + Math.floor( Bret_random() * 256);
          b[39] &= 0xFF;
        } else {
      ...
      case 1071248168:
        if (56916210n) {
          b[41] += b[11] + b[27] + b[37] + b[2] + b[18] + b[35] + Math.floor( ret_random() * 256);
          b[41] &= 0xFF;
        } else {
      ...
      case 1071664271:
        if ( Aret_random() < 0.5) {
          ...
          b[18] ^= (b[20] + b[23] + b[6] + b[12] + b[4] + b[25] + Math.floor( Bret_random() * 256)) & 0xFF;
        }
        state = 175099911;
        continue;
      case 1071767211:
